...
function SearchBox(t0) {
    ...
    if ($[0] !== "2fd5e823e83545ddf988c8219be75a8137aabaa79c1c19e853466018fe45b2b8") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2fd5e823e83545ddf988c8219be75a8137aabaa79c1c19e853466018fe45b2b8";
    }
...
function Pagination(t0) {
    ...
    if ($[0] !== "eae1f3449b84adb7c2e858f36759678bb29d6199b772c7ce03d73419696c9052") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "eae1f3449b84adb7c2e858f36759678bb29d6199b772c7ce03d73419696c9052";
    }
    const { page, totalPages, onChange } = t0;
    if (totalPages <= 1) {
        return null;
    }
    let t1;
...
"[project]/components/hooks/UseDebounce.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useDebounce(value, t0) {
    ...
    if ($[0] !== "1f1f1db03973f8e43201fd76e40f4275a76e45dc4c1b2fa4074669aacbcf5ab1") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1f1f1db03973f8e43201fd76e40f4275a76e45dc4c1b2fa4074669aacbcf5ab1";
    }
    ...
    if ($[1] !== delay || $[2] !== value) {
        t1 = ({
            "useDebounce[useEffect()]": ()=>{
                const id = setTimeout({
                    "useDebounce[useEffect() > setTimeout()]": ()=>setDebounced(value)
...
__turbopack_context__.v({
  "actions": "NoteList-module__LCs_aq__actions",
  "content": "NoteList-module__LCs_aq__content",
  "date": "NoteList-module__LCs_aq__date",
  "deleteButton": "NoteList-module__LCs_aq__deleteButton",
  "empty": "NoteList-module__LCs_aq__empty",
  "header": "NoteList-module__LCs_aq__header",
  "item": "NoteList-module__LCs_aq__item",
...
function NoteList(t0) {
    ...
    if ($[0] !== "65418ddbe5b035f44719cb835f051243e310b123b0a9544e1ef1a7dd068ac8e8") {
        for(let $i = 0; $i < 13; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "65418ddbe5b035f44719cb835f051243e310b123b0a9544e1ef1a7dd068ac8e8";
    }
    const { notes } = t0;
    ...
    const { mutate: removeNote, isPending } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])(t1);
    if (!notes.length) {
        let t2;
    ...
    let t2;
    if ($[4] !== isPending || $[5] !== notes || $[6] !== removeNote) {
        let t3;
        if ($[8] !== isPending || $[9] !== removeNote) {
            t3 = ({
                "NoteList[notes.map()]": (note)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                        className: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$NoteList$2f$NoteList$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].item,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$NoteList$2f$NoteList$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].header,
                                children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$NoteList$2f$NoteList$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].date,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        onClick: {
                                            "NoteList[notes.map() > <button>.onClick]": ()=>removeNote(note.id)
...
_s(NoteList, "DW2Y4OaVFT50kU6Zt6WXzgk37XQ=", false, function() {
    return [
...
function Modal({ children, onClose }) {
    ...
    ;
    function handleBackdropClick(e_0) {
        if (e_0.target === e_0.currentTarget) onClose();
    }
}
...
function NoteForm(t0) {
    ...
    if ($[0] !== "602f343bf544a40324ca5bc5a9745f318169420c31d41c936c7fa603fc032696") {
        for(let $i = 0; $i < 12; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "602f343bf544a40324ca5bc5a9745f318169420c31d41c936c7fa603fc032696";
    }
    const { onClose } = t0;
    const queryClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"])();
    let t1;
    ...
    if ($[4] !== mutate) {
        t2 = ({
            "NoteForm[handleSubmit]": (values, helpers)=>{
    ...
    let t3;
    if ($[6] !== isPending || $[7] !== onClose) {
        t3 = (t4)=>{
            const { isSubmitting, resetForm } = t4;
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                onClick: {
                                    "NoteForm[<anonymous> > <button>.onClick]": ()=>{
                                        resetForm();
                                        onClose();
                                    }
                                }["NoteForm[<anonymous> > <button>.onClick]"],
...
_s(NoteForm, "wOtU2fMy1A4Hu5zoa0qdJ4ls63E=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"]
    ];
...
function _temp(payload) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNote"])(payload);
}
var _c;
...
function Loading() {
    ...
    if ($[0] !== "ead3391581f9941a36ca203e4712b910b96a5a8285008e55baca99a89f1497d6") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ead3391581f9941a36ca203e4712b910b96a5a8285008e55baca99a89f1497d6";
    }
    let t0;
...
"[project]/app/notes/filter/[...slug]/LayoutNotes.module.css [app-client] (css module)", ((__turbopack_context__) => {

__turbopack_context__.v({
  "app": "LayoutNotes-module___ALNLq__app",
  "button": "LayoutNotes-module___ALNLq__button",
  "toolbar": "LayoutNotes-module___ALNLq__toolbar",
});
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$hooks$2f$UseDebounce$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/hooks/UseDebounce.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$notes$2f$filter$2f5b2e2e2e$slug$5d2f$LayoutNotes$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/app/notes/filter/[...slug]/LayoutNotes.module.css [app-client] (css module)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function NotesClient(t0) {
    ...
    if ($[0] !== "e96c8f8586e13ef2bbf1045dd8b92d2040ccb3b66da050bab86cfdc6af158aa9") {
        for(let $i = 0; $i < 33; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e96c8f8586e13ef2bbf1045dd8b92d2040ccb3b66da050bab86cfdc6af158aa9";
    }
    const { category } = t0;
    ...
    const debouncedSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$hooks$2f$UseDebounce$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDebounce"])(topic, 500);
    let t1;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ({
    ...
    let t2;
    if ($[2] !== category || $[3] !== debouncedSearch || $[4] !== page) {
        t2 = {
            queryKey: [
                "notes",
                {
    ...
    const { data, isLoading, isError, isSuccess, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])(t2);
    let t3;
    ...
    if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
        t8 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            type: "button",
            className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$notes$2f$filter$2f5b2e2e2e$slug$5d2f$LayoutNotes$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].button,
            onClick: openModal,
            children: "Create note +"
        }, void 0, false, {
            fileName: "[project]/app/notes/filter/[...slug]/Notes.client.tsx",
    ...
    let t13;
    if ($[26] !== t10 || $[27] !== t11 || $[28] !== t12 || $[29] !== t6 || $[30] !== t7 || $[31] !== t9) {
        t13 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$notes$2f$filter$2f5b2e2e2e$slug$5d2f$LayoutNotes$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].app,
            children: [
                t6,
                t7,
                t8,
...
_s(NotesClient, "DGxc1YT6r3QpAMuqGilKF5UYNZk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$hooks$2f$UseDebounce$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDebounce"],
...
//# sourceMappingURL=_48556ccc._.js.map